/**
 * BackendStatisticErrorsPerRouteResource generated on 2021-01-29
...
export default class BackendStatisticErrorsPerRouteResource {
    private url: string;
     ...
     */
    public backendActionStatisticGetErrorsPerRoute(query?: Backend_Log_Collection_Query): AxiosPromise<Statistic_Count> {
        let params = {
            method: "GET",
            params: query,
            headers: {
